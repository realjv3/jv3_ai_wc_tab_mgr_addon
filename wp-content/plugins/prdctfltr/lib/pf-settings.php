...
/*					'prdctfltr_filtering_mode' => array(
					...
					'prdctfltr_caching' => array(
						'name' => __( 'Product Filter Options Caching', 'prdctfltr' ),
						'type' => 'checkbox',
						'desc' => __( 'Uncheck this option to disable Product Filter options caching.', 'prdctfltr' ),
						'id'   => 'wc_settings_prdctfltr_caching',
						'default' => 'yes'
					),
