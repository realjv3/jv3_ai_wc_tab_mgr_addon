...
class DHWC_Widget_Brand_Slider extends WP_Widget {
	...
	public function __construct(){
		...
		if (!is_admin()){
			...
			wp_enqueue_script('dhwc-widget-brand-slider',DHVC_WOO_URL.'/dhwc-brand/assets/js/jquery.bxslider.min.js',array('jquery'),'',true);
		}
		
	}
	
	function enqueue_scripts(){
		wp_enqueue_style('dhwc-widget-brand-slider',DHVC_WOO_URL.'/dhwc-brand/assets/css/jquery.bxslider.css');
