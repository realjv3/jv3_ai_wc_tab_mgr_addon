...
<div class="body">
        ...
        <header class="site-header">
            <div class="container sp-cont">
                ...
                <div class="header-right">
               	<a href="#" class="visible-sm visible-xs" id="menu-toggle"><i class="fa fa-bars fa-2x"></i></a>

                <?php if(is_plugin_active("imithemes-listing/listing.php")) { if($imic_options['search_position']==0) { ?>
                    <div class="search-function">
                       
                                           <span><?php if($imic_options['search_text']=='') { ?><i class="fa fa-phone"></i> <?php echo esc_attr_e('Call us','framework'); ?> <strong><?php echo esc_attr_e('888-275-7425','framework'); ?></strong> <em><?php echo esc_attr_e('or search by keyword','framework'); ?></em> <?php } else { echo esc_attr($imic_options['search_text']); } ?></span>
    ...
    <form action="<?php echo esc_url( home_url( '/' ) ); ?>" method="get"  id="searchform" >
     ...
     <input type="submit" id="searchsubmit" value="Search" placeholder="Enter VIN #, model, make..." class="btn btn-primary"  />
