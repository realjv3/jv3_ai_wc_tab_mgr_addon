                ...
                <article class="single-vehicle-details">
                    ...
                    <div class="single-listing-actions">
                        <div class="btn-group pull-right" role="group">
                            ...
                            <?php } if($download_pdf!='') { ?>
                            <a href="<?php echo IMIC_THEME_PATH; ?>/download/download.php?file=<?php echo esc_url($download_pdf); ?>" class="btn btn-default" title="<?php echo esc_attr_e('Download Brochure','framework'); ?>"><i class="fa fa-book"></i> <span><?php echo esc_attr_e('Download Brochure','framework'); ?></span></a><?php } ?>
